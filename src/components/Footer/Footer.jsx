        ...
        <footer className='bg-[#12141e] pt-12'>
            ...
            <div className="container">
                <div className="sm:flex items-center justify-between md:gap-8 ">
                    ...
                    <div className="w-full sm:w-1/2 ">
                        <p className='text-gray-300 leading-7 mt-4 sm:mt-0'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur sapiente architecto veritatis inventore, optio voluptatibus necessitatibus. Maxime mollitia consequuntur voluptatem?</p>

                        <div className="flex items-center gap-4 flex-wrap md:gap-8 mt-10">
                            <span className='text-gray-300 font-[600] text-[15px]'>Follow Me:</span>

                            <span className='w-[35px] h-[35px] bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center'><a href="#github" className='text-gray-300 font-[500] text-[18px]'>
                                <i class="ri-github-line"></i></a></span>
                            <span className='w-[35px] h-[35px] bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center'><a href="#youtube" className='text-gray-300 font-[500] text-[18px]'>
                                <i class="ri-youtube-line"></i></a></span>

                            <span className='w-[35px] h-[35px] bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center'><a href="#facebook" className='text-gray-300 font-[500] text-[18px]'>
                                <i class="ri-facebook-circle-line"></i></a></span>
                            <span className='w-[35px] h-[35px] bg-[#2b2d33] p-1 rounded-[50px] cursor-pointer text-center'><a href="#instagram" className='text-gray-300 font-[500] text-[18px]'>

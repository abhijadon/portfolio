                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-[10px]">
                        ...
                        <div className="leading-[20px]">
                            ...
                            <p className='text-smallTextColor text-[14px] font-[600]'>PortFolio</p>
                        </div>
                    </div>
                    {/* =============logo end============= */}
                    ...
                    <div className="flex items-center gap-4">
                        <button className='flex items-center gap-2 text-smallTextColor font-[400] border border-solid border-smallTextColor py-2 px-4 rounded-[8px] max-h-[40px] hover:bg-smallTextColor hover:text-white hover:font-[300]'>
